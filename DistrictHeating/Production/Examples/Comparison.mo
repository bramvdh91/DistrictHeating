...
model Comparison
  ...
  PolynomialProduction polynomialProduction(
    ...
    m_flow_nominal=0.1,
    dp_nominal=0,
    redeclare Data.Polynomials.Boiler2ndDegree
      data,
    modulationMin=20,
    modulationStart=30,
    QNom=5000)
  ...
  PerformanceMapProduction performanceMapProduction(
    ...
    redeclare package Medium = Modelica.Media.Water.ConstantPropertyLiquidWater,
    m_flow_nominal=0.1,
    redeclare Data.PerformanceMaps.Boiler                                  data,
    modulationMin=20,
    modulationStart=30,
    QNom=5000)
  ...
  IDEAS.Fluid.FixedResistances.Pipe_Insulated pipe1(
    UA=10,
    m_flow_nominal=0.1,
    redeclare package Medium = Modelica.Media.Water.ConstantPropertyLiquidWater,
    m=1,
  ...
  IDEAS.Fluid.Sensors.TemperatureTwoPort senInterpolation(redeclare package
      Medium = Modelica.Media.Water.ConstantPropertyLiquidWater, m_flow_nominal=
       0.1) annotation (Placement(transformation(extent={{10,-26},{30,-6}})));
