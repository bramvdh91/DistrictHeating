...
partial model HeatingSystemDH "Partial heating/cooling system"
  ...
  extends PartialTwoPortInterfaceVertical(                       m_flow(nominal=10));
...
public
  ...
  IDEAS.Electric.BaseClasses.WattsLawPlug wattsLawPlug(each numPha=1, final
      nLoads=nLoads) if nLoads >= 1
